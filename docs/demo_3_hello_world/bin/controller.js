...
Controller.mainLoop = function() {
	...
	var this1 = this2.sc(Controller.getAndDisplayAnswer());
	var this2 = this1.sc(Controller.hide(Controller.question));
	var this1 = this2.sc(Controller.hide(Controller.nameBox));
	var this2 = this1.sc(tbc_TBCTime.pause(1000));
...
Controller.enter = function(el) {
	...
	return tbc_Guard.filter(tbc_TBCHTML.keypress(Controller.nameBox),isEnterKey);
};
Controller.getAndDisplayAnswer1 = function() {
	var f = function(top) {
		...
		var this2 = this1.bind(Controller.hello);
		var this1 = tbc_TBCTime.timeout(5000).sc(Controller.flash(Controller.question));
		var this3 = this1.sc(tbc_TBC.invoke(top));
		var this1 = this2.orElse(this3);
...
Controller.flash = function(el) {
	...
	var this1 = this2.sc(tbc_TBCTime.pause(100));
	var this2 = this1.sc(Controller.hide(el));
	var this1 = this2.sc(tbc_TBCTime.pause(100));
	var this2 = this1.sc(Controller.show(el));
	return this2;
};
...
tbc_ProcessI.__isInterface__ = true;
...
tbc_Disabler.__isInterface__ = true;
...
tbc_GuardedProcessI.__isInterface__ = true;
...
tbc_GuardI.__isInterface__ = true;
tbc_GuardI.__interfaces__ = [tbc_GuardedProcessI];
