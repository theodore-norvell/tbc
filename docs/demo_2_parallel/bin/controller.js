...
Controller.useCase = function() {
	...
	var this3 = Controller.out("y0").sc(tbc_TBCTime.pause(1000));
	var this4 = this3.sc(Controller.out("y1"));
	var this5 = tbc_TBC.par(this2,this4).sc(tbc_TBCTime.pause(1000));
	return tbc_TBC.loop(this5);
};
Controller.onload = function() {
	var win = window;
	var doc = win.document;
	Controller.outbox = doc.getElementById("outbox");
	haxe_Log.trace("Last compiled " + "2019-05-01 17:20:14",{ fileName : "docs/demo_2_parallel/src/Controller.hx", lineNumber : 46, className : "Controller", methodName : "onload"});
