...
Controller.out = function(str) {
	return tbc_TBC.exec(function() {
		haxe_Log.trace(str,{ fileName : "docs/demo_5_try_the_tm/src/Controller.hx", lineNumber : 68, className : "Controller", methodName : "out"});
		return null;
	});
};
	...
	var this1 = Controller.getTheTMApplet().bind(function(tm) {
		if(tm == null) {
			...
			var this2 = Controller.getTextFromCodeMirror(lang).bind(function(src) {
				return tbc_TBC.exec(function() {
					try {
						haxe_Log.trace("loadSting" + fileName + ": " + src,{ fileName : "docs/demo_5_try_the_tm/src/Controller.hx", lineNumber : 151, className : "Controller", methodName : "sendToTM"});
						tm.loadString(fileName,src);
						haxe_Log.trace("loadString returns",{ fileName : "docs/demo_5_try_the_tm/src/Controller.hx", lineNumber : 153, className : "Controller", methodName : "sendToTM"});
					} catch( e ) {
						haxe_CallStack.lastException = e;
						haxe_Log.trace("Error on send to TM " + Std.string((((e) instanceof js__$Boot_HaxeError) ? e.val : e).toString()),{ fileName : "docs/demo_5_try_the_tm/src/Controller.hx", lineNumber : 156, className : "Controller", methodName : "sendToTM"});
...
Controller.onload = function() {
	...
	haxe_Log.trace("Last compiled " + "2019-05-01 17:20:16",{ fileName : "docs/demo_5_try_the_tm/src/Controller.hx", lineNumber : 222, className : "Controller", methodName : "onload"});
	haxe_Log.trace("Started at " + Std.string(new Date()),{ fileName : "docs/demo_5_try_the_tm/src/Controller.hx", lineNumber : 223, className : "Controller", methodName : "onload"});
	var p = Controller.initialState();
	p.go(function(x) {
	},function(ex) {
		haxe_Log.trace("Exception " + Std.string(ex),{ fileName : "docs/demo_5_try_the_tm/src/Controller.hx", lineNumber : 226, className : "Controller", methodName : "onload"});
	});
};
