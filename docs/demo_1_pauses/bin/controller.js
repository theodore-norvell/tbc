...
Controller.out = function(str) {
	return tbc_TBC.exec(function() {
		Controller.outbox.innerHTML = str;
		return null;
	});
};
Controller.nagTheUser = function() {
	var this1 = Controller.out("hurry up").sc(tbc_TBCTime.pause(500));
	var this2 = this1.sc(Controller.out(""));
	return this2;
};
Controller.useCase = function() {
	var this1 = Controller.nag();
	var this2 = tbc__$TBC_Guard_$Impl_$.andThen(tbc_TBCHTML.click(Controller.b1a),Controller.out("1A")).orElse(tbc__$TBC_Guard_$Impl_$.andThen(tbc_TBCHTML.click(Controller.b1b),Controller.out("1B")));
	var this3 = this2.orElse(tbc__$TBC_Guard_$Impl_$.andThen(tbc_TBCTime.timeout(2000),Controller.out("too slow")));
	var this4 = this1.sc(tbc_TBC.await(this3));
	var this5 = this4.sc(tbc_TBCTime.pause(1000));
	var this6 = this5.sc(tbc_TBC.await(tbc__$TBC_Guard_$Impl_$.andThen(tbc_TBCHTML.click(Controller.b2),Controller.out("2"))));
	return tbc_TBC.loop(this6);
};
Controller.nag = function() {
	var f = function(repeat) {
		var this1 = tbc__$TBC_Guard_$Impl_$.andThen(tbc_TBCHTML.click(Controller.b0),Controller.out("0"));
		var gp = tbc_TBCTime.timeout(1500);
		var this2 = Controller.nagTheUser().sc(tbc_TBC.invoke(repeat));
		var this3 = this1.orElse(tbc__$TBC_Guard_$Impl_$.andThen(gp,this2));
		return tbc_TBC.await(this3);
	};
...
Controller.onload = function() {
	...
	haxe_Log.trace("Last compiled " + "2019-05-01 17:20:13",{ fileName : "docs/demo_1_pauses/src/Controller.hx", lineNumber : 67, className : "Controller", methodName : "onload"});
	...
	Controller.useCase().go(function(x) {
		...
		haxe_Log.trace("Exception " + Std.string(ex),{ fileName : "docs/demo_1_pauses/src/Controller.hx", lineNumber : 70, className : "Controller", methodName : "onload"});
	});
	haxe_Log.trace("going",{ fileName : "docs/demo_1_pauses/src/Controller.hx", lineNumber : 71, className : "Controller", methodName : "onload"});
};
