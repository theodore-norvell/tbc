...
Controller.useCase = function() {
	...
	var this2 = tbc_TBCHTML.click(Controller.b1a).sc(Controller.out("1A"));
	var this3 = tbc_TBCHTML.click(Controller.b1b).sc(Controller.out("1B"));
	var this4 = this2.orElse(this3);
	var this2 = tbc_TBCTime.timeout(2000).sc(Controller.out("too slow"));
	var this3 = this4.orElse(this2);
	var this2 = this1.sc(tbc_TBC.await(this3));
	var this1 = this2.sc(tbc_TBCTime.pause(1000));
	var this2 = tbc_TBCHTML.click(Controller.b2).sc(Controller.out("2"));
	var this3 = this1.sc(tbc_TBC.await(this2));
	return tbc_TBC.loop(this3);
};
Controller.nag = function() {
	var f = function(repeat) {
		var this1 = tbc_TBCHTML.click(Controller.b0).sc(Controller.out("0"));
		var this2 = tbc_TBCTime.timeout(1500).sc(Controller.nagTheUser());
		var this3 = this2.sc(tbc_TBC.invoke(repeat));
		var this2 = this1.orElse(this3);
		return tbc_TBC.await(this2);
	};
