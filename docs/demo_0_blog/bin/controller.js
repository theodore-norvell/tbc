...
Controller.useCase = function() {
	...
	var this2 = tbc_TBC.await(this1);
	var this1 = tbc_TBCHTML.click(Controller.b1a).sc(Controller.out("1A"));
	var this3 = tbc_TBCHTML.click(Controller.b1b).sc(Controller.out("1B"));
	var this4 = this2.sc(tbc_TBC.await(this1,this3));
	var this1 = tbc_TBCHTML.click(Controller.b2).sc(Controller.out("2"));
	var this2 = this4.sc(tbc_TBC.await(this1));
...
Controller.onload = function() {
	...
	haxe_Log.trace("Last compiled " + "2021-05-27 19:45:02",{ fileName : "docs/demo_0_blog/src/Controller.hx", lineNumber : 53, className : "Controller", methodName : "onload"});
