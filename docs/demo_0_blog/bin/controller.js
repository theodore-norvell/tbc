...
Controller.useCase = function() {
	var this1 = tbc_TBC.await(tbc__$TBC_Guard_$Impl_$.andThen(tbc_TBCHTML.click(Controller.b0),Controller.out("0"))).sc(tbc_TBC.await(tbc__$TBC_Guard_$Impl_$.andThen(tbc_TBCHTML.click(Controller.b1a),Controller.out("1A")),tbc__$TBC_Guard_$Impl_$.andThen(tbc_TBCHTML.click(Controller.b1b),Controller.out("1B"))));
	var this2 = this1.sc(tbc_TBC.await(tbc__$TBC_Guard_$Impl_$.andThen(tbc_TBCHTML.click(Controller.b2),Controller.out("2"))));
...
Controller.onload = function() {
	...
	haxe_Log.trace("Last compiled " + "2019-05-01 17:20:13",{ fileName : "docs/demo_0_blog/src/Controller.hx", lineNumber : 53, className : "Controller", methodName : "onload"});
	haxe_Log.trace("Started at " + Std.string(new Date()),{ fileName : "docs/demo_0_blog/src/Controller.hx", lineNumber : 54, className : "Controller", methodName : "onload"});
	Controller.useCase().go(function(x) {
	},function(ex) {
		haxe_Log.trace("Exception " + Std.string(ex),{ fileName : "docs/demo_0_blog/src/Controller.hx", lineNumber : 56, className : "Controller", methodName : "onload"});
	});
	haxe_Log.trace("going",{ fileName : "docs/demo_0_blog/src/Controller.hx", lineNumber : 57, className : "Controller", methodName : "onload"});
};
