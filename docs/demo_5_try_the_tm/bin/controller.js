...
Controller.main = function() {
	...
	Controller.doc = Controller.win.document;
	var body = Controller.doc.body;
	body.onload = Controller.onload;
};
Controller.showPopup = function(e) {
	e.setAttribute("class","popup visible");
};
Controller.hidePopup = function(e) {
	e.setAttribute("class","popup hidden");
};
Controller.clearWarning = function() {
	Controller.hidePopup(Controller.warning);
};
Controller.showPopupP = function(e) {
	return tbc_TBC.exec(function() {
		Controller.showPopup(e);
		return null;
	});
};
Controller.hidePopupP = function(e) {
	return tbc_TBC.exec(function() {
		Controller.hidePopup(e);
		return null;
	});
};
Controller.out = function(str) {
	return tbc_TBC.exec(function() {
		haxe_Log.trace(str,{ fileName : "demo_5_try_the_tm/src/Controller.hx", lineNumber : 68, className : "Controller", methodName : "out"});
		return null;
	});
};
Controller.show = function(e) {
	var this1 = Controller.out("Showing").sc(tbc_TBC.exec(function() {
		e.style.visibility = "visible";
		return null;
	}));
	return this1;
};
Controller.hide = function(e) {
	var this1 = Controller.out("hiding").sc(tbc_TBC.exec(function() {
		e.style.visibility = "hidden";
		return null;
	}));
	return this1;
};
Controller.showTM = function() {
	var this1 = Controller.out("showing TM").sc(tbc_TBC.exec(function() {
		Controller.tmContainer.setAttribute("class","onTop");
		Controller.editorContainerContainerContainer.setAttribute("class","onBottom");
		return null;
	}));
	var this2 = this1.sc(tbc_TBCTime.pause(2000));
	return this2;
};
Controller.hideTM = function() {
	var this1 = Controller.out("hiding TM").sc(tbc_TBC.exec(function() {
		Controller.editorContainerContainerContainer.setAttribute("class","onTop");
		Controller.tmContainer.setAttribute("class","onBottom");
		return null;
	}));
	var this2 = this1.sc(tbc_TBCTime.pause(2000));
	return this2;
};
Controller.rotateVisible = function(e) {
	var this1 = Controller.out("Rotate to visible").sc(tbc_TBC.exec(function() {
		e.style.transform = "rotateY(0deg)";
		e.style.WebkitTransform = "rotateY(0deg)";
		return null;
	}));
	return this1;
};
Controller.rotateInVisible = function(e) {
	var this1 = Controller.out("Rotate to invisible").sc(tbc_TBC.exec(function() {
		e.style.transform = "rotateY(90deg)";
		e.style.WebkitTransform = "rotateY(90deg)";
		return null;
	}));
	return this1;
};
Controller.swap = function(oldContainer,newContainer,editor) {
	var this1 = Controller.rotateInVisible(oldContainer).sc(tbc_TBCTime.pause(300));
	var this2 = this1.sc(Controller.hide(oldContainer));
	var this3 = this2.sc(tbc_TBCTime.pause(300));
	var this4 = this3.sc(Controller.show(newContainer));
	var this5 = this4.sc(Controller.rotateVisible(newContainer));
	return this5;
};
Controller.showEditor = function(toLang) {
	var this1 = Controller.show(Controller.topContainer).sc(Controller.swap(Controller.editorContainer[1 - toLang],Controller.editorContainer[toLang],Controller.editor[toLang]));
	return this1;
};
Controller.getTheTMApplet = function() {
	return tbc_TBC.exec(function() {
		return getTMApplet();
	});
};
Controller.getTextFromCodeMirror = function(lang) {
	return tbc_TBC.exec(function() {
		return Controller.editor[lang].getValue("\n");
	});
};
Controller.sendToTM = function(lang) {
	var fileName = lang == Controller.CPP ? "tryItNow.cpp" : "tryItNow.java";
	var this1 = Controller.getTheTMApplet().bind(function(tm) {
		if(tm == null) {
			return tbc_TBC.unit(null);
		} else {
			var this2 = Controller.getTextFromCodeMirror(lang).bind(function(src) {
				return tbc_TBC.exec(function() {
					try {
						haxe_Log.trace("loadSting" + fileName + ": " + src,{ fileName : "demo_5_try_the_tm/src/Controller.hx", lineNumber : 151, className : "Controller", methodName : "sendToTM"});
						tm.loadString(fileName,src);
						haxe_Log.trace("loadString returns",{ fileName : "demo_5_try_the_tm/src/Controller.hx", lineNumber : 153, className : "Controller", methodName : "sendToTM"});
					} catch( e ) {
						haxe_CallStack.lastException = e;
						haxe_Log.trace("Error on send to TM " + Std.string((((e) instanceof js__$Boot_HaxeError) ? e.val : e).toString()),{ fileName : "demo_5_try_the_tm/src/Controller.hx", lineNumber : 156, className : "Controller", methodName : "sendToTM"});
						Controller.win.alert("There was a problem sending the code to the Teaching Machine." + " Try again. If the problem persists, contact Theodore" + " Norvell (theo@mun.ca)");
					}
					return null;
				});
			});
...
Controller.initialState = function() {
	var this1 = tbc__$TBC_Guard_$Impl_$.andThen(tbc_TBCHTML.change(Controller.radio[Controller.CPP]),tbc_TBC.unit(Controller.CPP)).orElse(tbc__$TBC_Guard_$Impl_$.andThen(tbc_TBCHTML.change(Controller.radio[Controller.JAVA]),tbc_TBC.unit(Controller.JAVA)));
	var this2 = tbc_TBC.await(this1).bind(function(lang) {
		var this3 = Controller.showEditor(lang).sc(Controller.editingState(lang));
		return this3;
	});
	return this2;
};
Controller.editingState = function(lang) {
	var this1 = Controller.changeLang(1 - lang).orElse(Controller.run(lang));
	return tbc_TBC.await(this1);
};
Controller.changeLang = function(toLang) {
	var tmp = tbc_TBCHTML.change(Controller.radio[toLang]);
	var this1 = Controller.showEditor(toLang).sc(tbc_TBC.unit(toLang));
	var this2 = this1.bind(Controller.editingState);
	return tbc__$TBC_Guard_$Impl_$.andThen(tmp,this2);
};
Controller.run = function(lang) {
	var tmp = tbc_TBCHTML.click(Controller.runButton[lang]);
	var this1 = Controller.showPopupP(Controller.loadWarning).sc(Controller.showTM());
	var this2 = this1.sc(Controller.sendToTM(lang));
	var this3 = this2.sc(Controller.hidePopupP(Controller.loadWarning));
	var this4 = this3.sc(tbc_TBC.await(tbc__$TBC_Guard_$Impl_$.andThen(tbc_TBCHTML.click(Controller.editButton),Controller.hideTM())));
	var this5 = this4.sc(tbc_TBC.unit(lang));
	var this6 = this5.bind(Controller.editingState);
	return tbc__$TBC_Guard_$Impl_$.andThen(tmp,this6);
};
Controller.onload = function() {
	Controller.warning = Controller.doc.getElementById("warning");
	Controller.dismissWarning = Controller.doc.getElementById("dismissWarning");
	Controller.loadWarning = Controller.doc.getElementById("loadWarning");
	Controller.topContainer = Controller.doc.getElementById("topContainer");
	Controller.editorContainerContainerContainer = Controller.doc.getElementById("editorContainerContainerContainer");
	Controller.tmContainer = Controller.doc.getElementById("teachingMachineContainer");
	Controller.editButton = Controller.doc.getElementById("editButton");
	Controller.radio[Controller.CPP] = Controller.doc.getElementById("cppRadio");
	Controller.radio[Controller.CPP].checked = false;
	Controller.radio[Controller.JAVA] = Controller.doc.getElementById("javaRadio");
	Controller.radio[Controller.JAVA].checked = false;
	Controller.editorContainer[Controller.CPP] = Controller.doc.getElementById("cppEditorContainer");
	Controller.editorContainer[Controller.JAVA] = Controller.doc.getElementById("javaEditorContainer");
	Controller.textArea[Controller.CPP] = Controller.doc.getElementById("cppTextArea");
	Controller.textArea[Controller.JAVA] = Controller.doc.getElementById("javaTextArea");
	Controller.editor[Controller.CPP] = CodeMirror.fromTextArea(Controller.textArea[Controller.CPP],{ mode : "text/x-c++src"});
	Controller.editor[Controller.JAVA] = CodeMirror.fromTextArea(Controller.textArea[Controller.JAVA],{ mode : "text/x-java"});
	Controller.runButton[Controller.CPP] = Controller.doc.getElementById("runCPPButton");
	Controller.runButton[Controller.JAVA] = Controller.doc.getElementById("runJavaButton");
	setTMReadyCallBack(Controller.clearWarning);
	Controller.dismissWarning.onclick = Controller.clearWarning;
	haxe_Log.trace("Last compiled " + "2019-05-01 16:00:13",{ fileName : "demo_5_try_the_tm/src/Controller.hx", lineNumber : 222, className : "Controller", methodName : "onload"});
	haxe_Log.trace("Started at " + Std.string(new Date()),{ fileName : "demo_5_try_the_tm/src/Controller.hx", lineNumber : 223, className : "Controller", methodName : "onload"});
	var p = Controller.initialState();
	p.go(function(x) {
	},function(ex) {
		haxe_Log.trace("Exception " + Std.string(ex),{ fileName : "demo_5_try_the_tm/src/Controller.hx", lineNumber : 226, className : "Controller", methodName : "onload"});
	});
};
...
tbc__$TBCHTML_ElementDisabler.prototype = {
	...
	,disableElement: function() {
		...
		if(el.tbc_event_handler_counter == null && el.disabled != null) {
			el.disabled = true;
		}
	}
};
...
tbc_ClickG.prototype = $extend(tbc_HTMLEventGuardA.prototype,{
	addHandler: function(k,h) {
		this._el.addEventListener("click",k);
	}
	,removeHandler: function(k,h) {
		this._el.removeEventListener("click",k);
	}
});
...
tbc_SubmitG.prototype = $extend(tbc_HTMLEventGuardA.prototype,{
	addHandler: function(k,h) {
		this._el.addEventListener("submit",k);
	}
	,removeHandler: function(k,h) {
		this._el.removeEventListener("submit",k);
	}
});
...
tbc_KeyPressG.prototype = $extend(tbc_HTMLEventGuardA.prototype,{
	addHandler: function(k,h) {
		this._el.addEventListener("keypress",k);
	}
	,removeHandler: function(k,h) {
		this._el.removeEventListener("keypress",k);
	}
});
...
tbc_ChangeG.prototype = $extend(tbc_HTMLEventGuardA.prototype,{
	addHandler: function(k,h) {
		this._el.addEventListener("change",k);
	}
	,removeHandler: function(k,h) {
		this._el.removeEventListener("change",k);
	}
});
