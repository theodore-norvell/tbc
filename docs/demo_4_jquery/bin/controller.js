...
Controller.onload = function() {
	var win = window;
	var doc = win.document;
	haxe_Log.trace("Last compiled " + "2019-05-01 17:20:15",{ fileName : "docs/demo_4_jquery/src/Controller.hx", lineNumber : 37, className : "Controller", methodName : "onload"});
	...
	var body = $("body");
	var this1 = Controller.upKey(body).guarding(tbc_TBCJQuery.preventDefault).sc(tbc_TBC.exec(Controller.bigger));
	var this2 = Controller.downKey(body).guarding(tbc_TBCJQuery.preventDefault).sc(tbc_TBC.exec(Controller.smaller));
	var p = tbc_TBC.loop(tbc_TBC.await(this1,this2));
	p.go(function(x) {
	},function(ex) {
...
Controller.upKey = function(els) {
	return tbc__$TBC_Guard_$Impl_$.filter(tbc_TBCJQuery.jqEvent(els,"keydown"),Controller.whichIs(38));
};
Controller.downKey = function(els) {
	return tbc__$TBC_Guard_$Impl_$.filter(tbc_TBCJQuery.jqEvent(els,"keydown"),Controller.whichIs(40));
};
