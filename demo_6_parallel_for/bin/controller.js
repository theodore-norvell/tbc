...
Controller.printStack = function() {
	haxe_Log.trace(haxe_CallStack.toString(haxe_CallStack.exceptionStack()),{ fileName : "demo_6_parallel_for/src/Controller.hx", lineNumber : 30, className : "Controller", methodName : "printStack"});
};
Controller.onload = function() {
	var win = window;
	var doc = win.document;
	haxe_Log.trace("Last compiled " + "2019-04-30 12:21:43",{ fileName : "demo_6_parallel_for/src/Controller.hx", lineNumber : 39, className : "Controller", methodName : "onload"});
	haxe_Log.trace("Started at " + Std.string(new Date()),{ fileName : "demo_6_parallel_for/src/Controller.hx", lineNumber : 40, className : "Controller", methodName : "onload"});
	var count = 16;
	var stage = $("#stage");
	...
	p.go(function(x) {
		...
		haxe_Log.trace("Exception " + Std.string(ex),{ fileName : "demo_6_parallel_for/src/Controller.hx", lineNumber : 66, className : "Controller", methodName : "onload"});
